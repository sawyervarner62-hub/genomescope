import { ClinicalContextEntry } from "@/types/genome";

export const CLINICAL_CONTEXT: Record<string, ClinicalContextEntry> = {
  "MTHFR|significantly_reduced": {
    mechanism:
      "The MTHFR enzyme converts folic acid to methylfolate (5-MTHF), the active form used by the body. With 70% reduced activity, you produce significantly less methylfolate, affecting over 200 methylation-dependent reactions.",
    implications: [
  ...
  "MTRR|significantly_reduced": {
    mechanism:
      "MTRR regenerates methylcobalamin (methyl-B12), the active form of B12. Impaired MTRR means B12 recycling is less efficient, potentially leading to functional B12 deficiency even with normal blood levels.",
    implications: [
  ...
  "PEMT|reduced": {
    mechanism:
      "PEMT creates phosphatidylcholine from phosphatidylethanolamine using SAMe. Reduced function means you rely more on dietary choline intake.",
    implications: [
  ...
  "COMT|slow": {
    mechanism:
      "COMT breaks down catecholamines (dopamine, norepinephrine, epinephrine). Slow COMT means these neurotransmitters remain active longer, leading to higher baseline levels.",
    implications: [
  ...
  "OPRM1|altered": {
    mechanism:
      "OPRM1 encodes the mu-opioid receptor. The A118G variant alters receptor binding, affecting response to endorphins, opioid medications, and reward from alcohol.",
    implications: [
  ...
  "CYP1A2|intermediate": {
    mechanism:
      "CYP1A2 is the primary enzyme metabolizing caffeine. Intermediate metabolizers clear caffeine at a moderate rate, with ~5-6 hour half-life.",
    implications: [
  ...
  "ADORA2A|anxiety_prone": {
    mechanism:
      "ADORA2A encodes adenosine receptors. This variant is associated with increased anxiety response to caffeine.",
    implications: [
  ...
  "ADORA2A|lower_sensitivity": {
    mechanism:
      "This variant is associated with lower caffeine sensitivity regarding anxiety.",
    implications: [
  ...
  "AGTR1|increased": {
    mechanism:
      "AGTR1 encodes the angiotensin II type 1 receptor. This variant is associated with increased receptor activity and hypertension risk.",
    implications: [
  ...
  "ACE|high": {
    mechanism:
      "Higher ACE activity means more conversion of angiotensin I to angiotensin II, a potent vasoconstrictor.",
    implications: [
  ...
  "AGT|increased": {
    mechanism:
      "AGT M235T is associated with higher angiotensinogen levels, feeding into the renin-angiotensin system.",
    implications: [
  ...
  "GNB3|increased": {
    mechanism:
      "GNB3 C825T affects G-protein signaling, associated with hypertension and obesity risk.",
    implications: [
      "Increased hypertension risk",
  ...
  "APOA2|sensitive": {
    mechanism:
      "APOA2 affects how saturated fat influences body weight. The CC genotype shows strong correlation between saturated fat intake and obesity.",
    implications: [
  ...
  "GC|low": {
    mechanism:
      "GC encodes vitamin D binding protein. This variant results in lower circulating 25-OH vitamin D levels.",
    implications: [
  ...
  "BCMO1|reduced": {
    mechanism:
      "BCMO1 converts beta-carotene to vitamin A. Reduced activity means less efficient conversion from plant sources.",
    implications: [
  ...
  "IL6|high": {
    mechanism:
      "IL-6 -174 G/G is associated with higher baseline IL-6 production, an inflammatory cytokine.",
    implications: [
  ...
  "HLA-DQA1|increased_risk": {
    mechanism:
      "HLA-DQ2.5 is strongly associated with celiac disease susceptibility. Not deterministic but increases risk.",
    implications: [
  ...
  "MC1R|accelerated": {
    mechanism:
      "MC1R variants affect melanin production and skin aging. V92M is associated with accelerated skin aging.",
    implications: [
  ...
  "ARNTL|significantly_altered": {
    mechanism:
      "BMAL1 (ARNTL) is a core circadian clock gene. This variant may weaken circadian rhythm strength.",
    implications: [
  ...
  "NAT2|intermediate": {
    mechanism:
      "NAT2 acetylates various drugs and toxins. Intermediate acetylators have moderate metabolism of NAT2 substrates.",
    implications: [
  ...
  "SOD2|high_activity": {
    mechanism:
      "SOD2 (MnSOD) is a key mitochondrial antioxidant enzyme. High activity (Ala/Ala) provides efficient superoxide neutralization.",
    implications: [
  ...
  "ACTN3|mixed": {
    mechanism:
      "ACTN3 R577X affects fast-twitch muscle fiber composition. R/X (heterozygous) provides balanced fiber distribution.",
    implications: [
  ...
  "ADRB2|gly16": {
    mechanism:
      "ADRB2 Gly16 is associated with enhanced lipolysis (fat burning) response to exercise and catecholamines.",
    implications: [
  ...
  "HFE|carrier": {
    mechanism:
      "HFE H63D is a minor hemochromatosis variant. Carriers have slightly increased iron absorption.",
    implications: [
  ...
  "TP53|arg72": {
    mechanism:
      "TP53 R72P affects p53 apoptotic efficiency. Arg72 has less efficient apoptosis induction.",
    implications: [
  ...
  "CETP|favorable": {
    mechanism:
      "CETP I405V affects cholesterol transfer between lipoproteins. This variant is associated with higher HDL and longevity.",
    implications: [
  ...
  "ADH1B|slow": {
    mechanism:
      "ADH1B affects the first step of alcohol metabolism (alcohol to acetaldehyde). Slow metabolizers have longer alcohol effects.",
    implications: [
  ...
  "CYP2C19|rapid": {
    mechanism:
      "CYP2C19*17 causes ultra-rapid metabolism of many drugs including PPIs, some antidepressants, and clopidogrel.",
    implications: [
  ...
  "CYP3A5|non_expressor": {
    mechanism:
      "CYP3A5*3/*3 means you don't express CYP3A5. CYP3A4 handles the work. This is the most common genotype in many populations.",
    implications: [
